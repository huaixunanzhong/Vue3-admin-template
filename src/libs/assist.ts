...
export const MutationObserver = isClient ? window.MutationObserver || false : false;

const SPECIAL_CHARS_REGEXP = /([\:\-\_]+(.))/g;
const MOZ_HACK_REGEXP = /^moz([A-Z])/;

function camelCase(name: string) {
    return name.replace(SPECIAL_CHARS_REGEXP, function(_: string, _separator: string, letter: string, offset: number) {
...
// Warn
export function warnProp(component: string, prop: string, correctType: string, wrongType: string) {
...
function findComponentUpward (context: any, componentName: string | string[], componentNames?: string[]) {
...
export function findComponentsDownward (context: any, componentName: string): any[] {
...
export function findBrothersComponents (context: any, componentName: string, exceptMe = true): any[] {
...
export const sharpMatcherRegex = /#([^#]+)$/;
