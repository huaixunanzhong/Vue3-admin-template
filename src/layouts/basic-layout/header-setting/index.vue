        ...
        <Drawer v-model="visible" width="280">
            ...
            <div class="i-layout-header-setting-item">
                ...
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="headerMenu" @on-change="(val:any) => handleChangeSetting('headerMenu', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item">
                <span class="i-layout-header-setting-item-desc">固定侧边栏</span>
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="siderFix" @on-change="(val:any) => handleChangeSetting('siderFix', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item">
                <span class="i-layout-header-setting-item-desc">固定顶栏</span>
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="headerFix" @on-change="(val:any) => handleChangeSetting('headerFix', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item" :class="{ 'i-layout-header-setting-item-disabled': !headerFix }">
                ...
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="headerHide" :disabled="!headerFix" @on-change="(val:any) => handleChangeSetting('headerHide', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item" :class="{ 'i-layout-header-setting-item-disabled': !headerFix }">
                <span class="i-layout-header-setting-item-desc">
                ...
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="headerStick" :disabled="!headerFix" @on-change="(val:any) => handleChangeSetting('headerStick', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item">
                <span class="i-layout-header-setting-item-desc">侧边栏开启手风琴模式</span>
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="menuAccordion" @on-change="(val:any) => handleChangeSetting('menuAccordion', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item">
                <span class="i-layout-header-setting-item-desc">显示折叠侧边栏按钮</span>
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="showSiderCollapse" @on-change="(val:any) => handleChangeSetting('showSiderCollapse', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item">
                <span class="i-layout-header-setting-item-desc">侧边栏折叠时显示父级菜单名</span>
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="showCollapseMenuTitle" @on-change="(val:any) => handleChangeSetting('showCollapseMenuTitle', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item">
                <span class="i-layout-header-setting-item-desc">
                ...
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="showBreadcrumb" @on-change="(val:any) => handleChangeSetting('showBreadcrumb', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item" :class="{ 'i-layout-header-setting-item-disabled': !showBreadcrumb }">
                ...
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="showBreadcrumbIcon" :disabled="!showBreadcrumb" @on-change="(val:any) => handleChangeSetting('showBreadcrumbIcon', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item">
                <span class="i-layout-header-setting-item-desc">显示重载页面按钮</span>
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="showReload" @on-change="(val:any) => handleChangeSetting('showReload', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item">
                <span class="i-layout-header-setting-item-desc">显示多语言选择</span>
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="showI18n" @on-change="(val:any) => handleChangeSetting('showI18n', val)" />
                </span>
            </div>
            ...
            <div class="i-layout-header-setting-item">
                ...
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="tabs" @on-change="(val:any) => handleChangeSetting('tabs', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item" :class="{ 'i-layout-header-setting-item-disabled': !tabs }">
                ...
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="showTabsIcon" :disabled="!tabs" @on-change="(val:any) => handleChangeSetting('showTabsIcon', val)" />
                </span>
            </div>
            <div class="i-layout-header-setting-item" :class="{ 'i-layout-header-setting-item-disabled': !tabs }">
                <span class="i-layout-header-setting-item-desc">
                ...
                <span class="i-layout-header-setting-item-action">
                    <Switch size="small" :model-value="tabsFix" :disabled="!tabs" @on-change="(val:any) => handleChangeSetting('tabsFix', val)" />
                </span>
            </div>
            <Alert type="warning">
                <template #desc>
                    <div>
                        该功能主要实时预览各种布局效果，更多完整配置在 <strong>setting.ts</strong> 中设置。建议在生产环境关闭该布局预览功能。
                    </div>
                </template>
            </Alert>
        </Drawer>
 ...
 <script lang="ts">
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            handleChangeSetting (key:any, value:any) {
