<template>
                ...
                <div class="i-layout-content-main">
                    <router-view #default="{ Component }">
                        <keep-alive :include="keepAlive">
                            <component :is="Component" :key="(Component as any).name" v-if="loadRouter" />
                        </keep-alive>
                    </router-view>
                </div>
            </Content>
 ...
 <script lang="ts">
    ...
    export default defineComponent({
        name: 'BasicLayout',
        components: { iMenuHead, iMenuSide, iCopyright, iHeaderLogo, iHeaderCollapse, iHeaderReload, iHeaderBreadcrumb, iHeaderSearch, iHeaderUser, iHeaderI18n, iHeaderLog, iHeaderFullscreen, iHeaderSetting, iHeaderNotice, iTabs, iWaterMark },
        data () {
            return {
                showDrawer: false,
                ticking: false,
