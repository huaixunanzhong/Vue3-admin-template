    ...
    export default defineComponent({
        ...
        data () {
            return {
                ...
                copyrightEl: null as any,
                layoutContentEl: null as any,
                layoutContentMainEl: null as any
            }
        },
        watch: {
            margin: {
                handler (val) {
                    nextTick(() => {
                        const contentEl:any = this.contentEl
                        if (contentEl) {
                            if (!val) {
                                contentEl.classList.add(noMarginClassName);
                            } else {
                                contentEl.classList.remove(noMarginClassName);
                            }
                        }
                    });
                },
